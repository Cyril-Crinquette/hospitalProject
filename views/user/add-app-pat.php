<h3 class="text-center">Ajout d'un patient avec un rendez-vous</h3>
            ...
            <div class="col-12 col-md-6">
                <div class="mb-4">
                    ...
                    <input required aria-describedby="mailHelp" type="email" name="mail" id="mail"
                        value="<?= $mail ?? '' ?>" class="form-control <?= isset($error['mail']) ? 'errorField' : '' ?>"
...
if (empty($errorDate)) { ?>
        <section class="appointment">
            ...
            <input type="submit" value="Ajouter le patient et son rendez-vous" class="btn btn-primary mt-3"
                id="validForm">
