<h3 class="text-center">Inscription d'un nouveau patient</h3>
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="mb-4">
                        ...
                        <input required aria-describedby="lastnameHelp" type="text" name="lastname" id="lastname"
                            ...
                            autocomplete="family-name" value="<?= htmlentities($lastname ?? '') ?>" minlength="2"
                ...
                <div class="col-12 col-md-6">
                    <div class="mb-4">
                        ...
                        <input required aria-describedby="firstnameHelp" type="text" name="firstname" id="firstname"
                            ...
                            autocomplete="family-name" value="<?= htmlentities($firstname ?? '') ?>" minlength="2"
                            maxlength="70" pattern="<?=REG_EXP_NO_NUMBER?>">
                ...
                <div class="col-12 col-md-6">
                    <div class="mb-4">
                        ...
                        <input required type="date" name="birthdate" placeholder="Entrez votre date de naissance*" id="birthdate" value="<?= htmlentities($birthdate ?? '') ?>"
                ...
                <div class="col-12 col-md-6">
                    <div class="mb-4">
                        ...
                        <input required type="tel" class="form-control" name="phone" id="phone" aria-
                            describedby="phoneHelp" placeholder="Entrez votre numéro de téléphone*" pattern="<?=REG_EXP_PHONE?>">
